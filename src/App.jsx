...
const MainContent = () => {
    ...
    return (
      <div className="relative min-h-screen bg-slate-950">
        <button
          ...
          className="fixed top-4 right-4 z-50 px-3.5 py-2 bg-slate-800/90 hover:bg-slate-700 text-white rounded-xl text-xs font-bold transition flex items-center gap-1.5 backdrop-blur-md border border-slate-700 shadow-lg no-print"
        >
        ...
        <footer className="bg-white border-t border-slate-200 py-6 text-center text-xs text-slate-500 space-y-2 no-print">
          ...
          <div>
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-lg text-[11px] font-bold transition"
            >
  ...
  // 4. VISTA PRINCIPAL DEL SISTEMA SEGÚN ROL AUTENTICADO
  return (
